...
cp ~/Downloads/attendance_checker.py attendance_checker.py
cp ~/Downloads/assets.csv Helpers/assets.csv
cp ~/Downloads/config.json Helpers/config.json
cp ~/Downloads/reports.log reports/reports.log
...
sed -i "s/\"warning_threshold\": *[0-9]*/\"warning_threshold\": $warning/" "$CONFIG_FILE"
